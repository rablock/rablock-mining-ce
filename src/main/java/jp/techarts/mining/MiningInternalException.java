...
public class MiningInternalException extends Exception {

  /** Auto generated UID. */
  private static final long serialVersionUID = 4078168540040636057L;

  public MiningInternalException(String message, Exception e) {
    super(message, e);
  }
}
