...
package jp.techarts.mining.auth;
...
public class WebSecurityDigestConfig extends WebSecurityConfigurerAdapter {
  ...
  public static final String REALM_NAME = "RaBlock";

  private final String password;
  private final String username;

  @Autowired
  public WebSecurityDigestConfig(final GetAppProperties app) {
    this.username = app.getDigestUserName();
    this.password = "{noop}" + app.getDigestPassword();
  }
